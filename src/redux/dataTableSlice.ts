...
export const dataTableSlice = createSlice({
  ...
  extraReducers: {
    [dataTableRedux.fulfilled.type]: (boolean) => console.log("fulfilled"),
    [dataTableRedux.pending.type]: (boolean) => console.log("pending"),
    [dataTableRedux.rejected.type]: (boolean) => console.log("rejected"),
  },
});
