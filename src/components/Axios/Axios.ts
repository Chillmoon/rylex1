...
import { PropsAddTable, PropsLogin, PropsTable } from "../../types/types";

export const logIn = ({ userData, successCallback }: PropsLogin) => {
...
export const signUp = ({ userData, successCallback }: PropsLogin) => {
  return axios
...
export const addTableData = (userData: PropsAddTable) => {
...
export const editTenant = ({ userData, id, tenantData }: PropsTable) => {
  const cleanDeep = require("clean-deep");
  const values = {
